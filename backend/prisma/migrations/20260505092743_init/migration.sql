...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_UPDATED', 'TASK_COMPLETED', 'PROJECT_INVITATION', 'COMMENT_ADDED', 'DEADLINE_REMINDER', 'MEMBER_JOINED', 'MEMBER_LEFT');
